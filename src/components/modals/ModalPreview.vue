    ...
    <div>
      <div class="vuefinder__preview-modal__content">
        <div v-if="enabledPreview">
          <TextComponent v-if="loadPreview('text')" @success="loaded = true" />
          <ImageComponent
...
import TextComponent from "../previews/Text.vue";
import ImageComponent from "../previews/Image.vue";
import Default from "../previews/Default.vue";
import VideoComponent from "../previews/Video.vue";
import AudioComponent from "../previews/Audio.vue";
import PdfComponent from "../previews/Pdf.vue";
...
const loadPreview = (type) =>
  (app.modal.data.item.mime_type ?? "").startsWith(type);
