      ...
      <div class="vuefinder__about-modal__main">
        ...
        >
          ...
          <a
            ...
            class="vuefinder__about-modal__link"
            target="_blank"
            >{{ t("Follow on GitHub") }}</a
          >
        </div>

        <div
          class="vuefinder__about-modal__tab-content"
          v-if="selectedTab === TAB.SETTINGS"
        >
          <div class="vuefinder__about-modal__description">
            ...
            <fieldset>
              ...
              <div class="vuefinder__about-modal__setting">
                ...
                <div class="vuefinder__about-modal__setting-label">
                  <select
                    id="theme"
                    v-model="app.theme.value"
                    @change="handleTheme($event.target.value)"
                    class="vuefinder__about-modal__select"
                  >
                    <optgroup :label="t('Theme')">
                      <option v-for="(name, key) in themes" :value="key">
                        {{ name }}
                      </option>
                    </optgroup>
                  </select>
                  <action-message class="ms-3" on="vf-theme-saved">{{
                    t("Saved.")
                  }}</action-message>
                </div>
              </div>
        ...
        <div
          class="vuefinder__about-modal__tab-content"
          v-if="selectedTab === TAB.SHORTCUTS"
        >
...
const { i18n } = proxy.$VueFinderOptions;
...
const supportedLanguages = Object.fromEntries(
  Object.entries(languageList).filter(([key]) =>
    Object.keys(i18n).includes(key)
  )
);
